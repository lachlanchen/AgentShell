...
Linux 向け公式 ChatGPT プレビューには Codex が含まれます。インストール後、次のランチャーで AgentShell のログインを利用し、アカウントごとに別のウィンドウを開けます。同じアカウントを再度開くと、起動中のアプリが再利用されます。
...
[インストール、ログイン、APT 更新、アカウント分離の詳細](../docs/desktop-linux.md).
